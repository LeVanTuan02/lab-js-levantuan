                        ...
                        ${result.map((post) => `
                            <div class="border border-gray-300 p-3 transition duration-300 linear hover:border-red-400">
                                <div class="overflow-hidden">
                                    <a href="/news/${post.id}" style="background-image: url('${post.img}');" class="block bg-no-repeat bg-center transition duration-300 ease-linear bg-cover hover:scale-105 pt-[65%]"></a>
                                </div>
