...
const TuyenSinhPage = {
    render() {
        ...
        <main class="container max-w-7xl mx-auto px-2">
            <section class="min-h-[calc(100vh-200px)] relative bg-no-repeat bg-cover bg-center" style="background-image: url(https://caodang.fpt.edu.vn/wp-content/uploads/3dfgd.jpg);">
